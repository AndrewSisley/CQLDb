...
pub fn _4d_read_location_1_100000_1_1<'a, TStore: CqlWritable + CqlReadable>(db_location: &'a str, value: TStore::ValueType) -> impl Fn() + 'a {
    let axis = [
        1,
        100000,
        1,
    ...
    static POINT1: [u64; 4] = [1, 100000, 1, 1];
